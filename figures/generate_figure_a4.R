...
# --- Load AFINN sentiment lexicon via tidytext ---
...
make_plot <- function() {
  ggplot(affect_afinn, aes(x = value, y = score, color = value > 0)) +
...
# Save PNG
p <- make_plot()
output_png <- file.path(output_dir, "figure_a4_sentiment_afinn.png")
